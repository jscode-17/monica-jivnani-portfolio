...
define( 'TP_ADDONS_VERSION_', '1.1.0');
...
include_once(TPCORE_WIDGET_PATH . '/tp-footer-about.php');
include_once(TPCORE_WIDGET_PATH . '/tp-footer-contact.php');
include_once(TPCORE_WIDGET_PATH . '/tp-footer-address.php');
