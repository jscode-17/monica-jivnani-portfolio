...
trait TPCoreElementFunctions
{
    ...
    protected function tp_common_animation($condition = null, $control_id = 'ani_demo', $control_name = 'Creative Animation', $style = 'tp_design_style'){
        $section_args = [
		...
		$this->start_controls_section(
			'creative_animation_'.$control_id.'_sec',
			$section_args
		);

        $this->add_control(
			'tp_creative_anima_'.$control_id.'_switcher',
			[
		...
		$this->add_control(
			'tp_anima_'.$control_id.'_type',
			[
				'label' => __('Animation Type', 'tpcore'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'no_animation' => __('None', 'tpcore'),
					'tp_title_anim' => __('Title', 'tpcore'),
                    'tp_text_anim' => __('Description', 'tpcore'),
                    'tp-split-text' => __('Split Text', 'tpcore'),
                    'tp-char-animation' => __('Character', 'tpcore'),
                    'tp_wrap_anim ' => __('Wrap ', 'tpcore'),
				],
				'default' => 'no_animation',
				'frontend_available' => true,
				'style_transfer' => true,
				'condition' => [
					'tp_creative_anima_'.$control_id.'_switcher' => 'yes',
				],
			]
		);
    ...
    protected function tp_common_animation_get($settings, $control_id = 'ani_demo'){
        $animation = '';
        if ('yes' === $settings['tp_creative_anima_'.$control_id.'_switcher']) {
            $animation = ' ' . $settings['tp_anima_'.$control_id.'_type'];
        }
        return $animation;
    }
    ...
    protected function tp_image_style($control_id = null, $control_name = 'Image Style', $selector = '.single-service .icon'){
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Radius', 'tp-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
    ...
    */
    ...
    protected function tp_link_controls_render($control_id = null, $control_name = 'tp-btn' , $settings = null)
    {
        ...
        if ('2' == $settings['tp_' . $control_id .'_link_type']) {
            ...
            $this->add_render_attribute('tp-button-arg' . $control_id .'', 'class', ''.$control_name.'');
        } else {
    ...
    protected function tp_post_layout($control_id = null, $control_name = null){
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Blog 1', 'tpcore'),
                    'layout-2' => esc_html__('Blog List', 'tpcore'),
                    'layout-3' => esc_html__('Blog List 2', 'tpcore'),
                    'layout-4' => esc_html__('Blog Slider', 'tpcore'),
                ],
                'default' => 'layout-1',
            ]
        );
    ...
    protected function tp_product_layout($control_id = null, $control_name = null){
        ...
        if(false){
            ...
            'tp_'. $control_id .'__slides_per_view',
             [
                'label'       => esc_html__( 'Slides Per View', 'tpcore' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
            ...
            'tp_'. $control_id .'__slides_per_view_lg',
             [
                'label'       => esc_html__( 'Slides Per View In LG (992px)', 'tpcore' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
            ...
            'tp_'. $control_id .'__slides_per_view_md',
             [
                'label'       => esc_html__( 'Slides Per View In MD (768px)', 'tpcore' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( '2', 'tpcore' ),
                'placeholder' => esc_html__( 'Your Number', 'tpcore' ),
                'condition' => [
            ...
            'tp_'. $control_id .'__slides_per_view_sm',
             [
                'label'       => esc_html__( 'Slides Per View In SM (576px)', 'tpcore' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
            ...
            'tp_'. $control_id .'__slides_per_view_xs',
             [
                'label'       => esc_html__( 'Slides Per View In XS (0-575px)', 'tpcore' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( '1', 'tpcore' ),
                'placeholder' => esc_html__( 'Your Number', 'tpcore' ),
                'condition' => [
