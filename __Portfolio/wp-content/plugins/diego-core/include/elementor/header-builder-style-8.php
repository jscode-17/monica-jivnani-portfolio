 ...
 * @since 1.0.0
 */
class TP_Header_08 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Header Builder Style 8', 'tpcore' );
	}
   ...
   <!-- header area start -->
   <header>
      <div class="tp-header-3__area tp-header-transparent tp-header-3__ptlr tp-header-5-top-space">
...
$widgets_manager->register( new TP_Header_08() );