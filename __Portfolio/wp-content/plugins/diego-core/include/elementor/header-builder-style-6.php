...
class TP_Header_06 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Header Builder Style 6', 'tpcore' );
	}
   ...
   <!-- header area start -->
   <header>
      <div class="tp-header-3__area tp-header-transparent tp-header-3__ptlr tp-header-5-style">
               ...
               <div class="col-xl-6 col-lg-6 col-md-6 col-6">
                  ...
                  <?php if($settings['tp_header_toggle'] == 'yes') : ?>
                     ...
                     <div class="tp-header-3__bar">
                        <button class="tp-menu-bar tp-offcanvas-open-btn" type="button">
                           <svg width="32" height="10" viewBox="0 0 32 10" fill="none" ßxmlns="http://www.w3.org/2000/svg">
   ...
   <!-- header area start -->
   <header>
      <div class="tp-header-3__area tp-header-transparent tp-header-3__ptlr tp-int-menu tp-header-5-sticky-bg tp-header-sticky-cloned">
