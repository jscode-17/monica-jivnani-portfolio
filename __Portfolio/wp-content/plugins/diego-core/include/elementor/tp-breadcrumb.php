...
class TP_Breadcrumb extends Widget_Base {
    ...
    protected function style_tab_content(){
        ...
        $this->tp_basic_style_controls('services_box_list', 'Box - Subtitle', '.tp-el-subtitle');
    }
    ...
    protected function render() {
        ...
        <div class="blog-list__area tp-el-section">
            <div class="blog-list__title-box tp-el-subtitle <?php echo esc_attr($settings['tp_section_align']); ?>">
                <?php if(!empty($settings['tp_breadcrumb_subtitle'])) : ?>   
                <span class="blog-list__subtitle tp-char-animation tp-el-subtitle"><?php echo tp_kses($settings['tp_breadcrumb_subtitle']); ?></span>
                <?php endif; ?>

                <?php if(!empty($settings['tp_breadcrumb_title'])) : ?>        
                <h4 class="blog-list__title tp-char-animation tp-el-title"><?php echo tp_kses($settings['tp_breadcrumb_title']); ?></h4>
                <?php endif; ?>     
            </div>
        </div>
