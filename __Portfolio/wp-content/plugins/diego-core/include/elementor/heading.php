...
class TP_Heading extends Widget_Base {
	...
	protected function render() {
		...
		?>
            ...
            <div class="tp-footer-6-cta-wrap text-center tp-el-section">
                <div class="tp-about-5-title-box text-center p-relative">


                    <?php if (!empty($settings['tp_slider_sub_title'])) : ?>
                    <span class="tp-about-5-subtitle <?php echo esc_attr($this->tp_common_animation_get($settings, 'desc_animation')) ?> tp-split-in-right tp-el-subtitle"><?php echo tp_kses( $settings['tp_slider_sub_title'] ); ?></span>
                    <?php endif; ?>
