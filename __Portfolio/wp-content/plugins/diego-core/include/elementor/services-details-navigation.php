 ...
 * @since 1.0.0
 */
class TP_Services_Details_Navigation extends Widget_Base {
    ...
    public function get_name() {
        return 'services-details-navigation';
    }
    ...
    public function get_title() {
        return __( 'Services Details Navigation', 'tpcore' );
    }
    ...
    protected function render() {
        ...
        ?>
            ...
            <div class="porfolio-details__navigation-area pb-120 tp-el-section">
               <div class="container">
                  <div class="row">
                     <div class="porfolio-details__navigation-wrap tp-el-box">
...
$widgets_manager->register( new TP_Services_Details_Navigation() ); 