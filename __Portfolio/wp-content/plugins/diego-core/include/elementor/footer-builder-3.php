 ...
 * @since 1.0.0
 */
class TP_Footer_03 extends Widget_Base
{
   ...
   {
      return __('Footer Builder 3', 'tpcore');
   }
   ...
   protected function style_tab_content()
   {
      ...
      $this->tp_link_controls_style('footer_btn_left', 'Footer Left - Button', '.tp-el-btn-left');
      $this->tp_link_controls_style('footer_btn_right', 'Footer Right - Button', '.tp-el-btn-right');
   ...
   protected function render()
   {
      ...
      $this->tp_link_controls_render('tpbtn', 'tp-btn-white-xl w-100 tp-el-btn-left', $this->get_settings());
      $this->tp_link_controls_render('tpbtn2', 'tp-btn-grey-xl w-100 tp-el-btn-right', $this->get_settings());
      ...
      <footer>
         <div class="tp-footer-bg tp-footer__customize  black-bg-3 p-relative fix z-index-1 tp-el-section"
                     ...
                     <div class="row">
                        <div class="col-xl-12">
                           <div class="tp-footer-content text-center">
                              <h3
                                 class="tp-footer-title <?php echo esc_attr($this->tp_common_animation_get($settings, 'desc_title')) ?> tp-el-title">
                                 <?php echo tp_kses($settings['tp_footer_title']); ?></h3>
                           </div>
                        </div>
                     </div>
                  <?php endif; ?>
...
$widgets_manager->register(new TP_Footer_03());
