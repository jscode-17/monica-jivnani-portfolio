...
class TP_Portfolio extends Widget_Base
{
    ...
    protected function register_controls_section()
    {
        ...
        $this->tp_section_title_render_controls('portfolio', 'Section Title', ['layout-1', 'layout-2']);
        ...
        $this->add_control(
            'tp_portfolio_bg_text',
            [
                'label' => esc_html__('BG Text', 'tpcore'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Latest Portfolio', 'tpcore'),
        ...
        $repeater->add_control(
            'tp_portfolio_image_height_switch',
            [
                'label' => esc_html__('Is Small Image?', 'tpcore'),
    ...
    protected function style_tab_content()
    {
        ...
        $this->tp_basic_style_controls('section_bg', 'Section - BG Text', '.tp-el-bg-text p');
    ...
    protected function render()
    {
                ...
                <div class="container">
                    <?php if (!empty($settings['tp_portfolio_section_title_show'])): ?>
                        <div class="row">
                            <div class="col-xl-12">
                                <div
                                    class="tp-project-3__title-box pb-30 text-center portfolio-sec-pin tp-el-content <?php echo esc_attr($this->tp_common_animation_get($settings, 'desc_animation')) ?>">

                                    <?php if (!empty($settings['tp_portfolio_sub_title'])): ?>
                                        <span
                                            class="tp-section-subtitle-3 <?php echo esc_attr($this->tp_common_animation_get($settings, 'desc_animation')) ?> tp-el-subtitle"><?php echo tp_kses($settings['tp_portfolio_sub_title']); ?></span>
                                    <?php endif; ?>
                        ...
                        <div class="col-xl-12">
                            <div class="tp-portfolio-item-wrapper-3">
                                <?php foreach ($settings['tp_portfolio_list'] as $key => $item):
                                    ...
                                    ?>
                                    <div class="tp-portfolio-item-3 portfolio-panel pb-80 tp-hover-reveal-text tp-el-box">
                                        <?php if ($item['tp_portfolio_link_switcher'] == 'yes'): ?>
                                            ...
                                            <div class="tp-portfolio-view-btn-3">
                                                <span class="tp-el-box-link"><?php echo tp_kses($item['portfolio_link_text']); ?></span>
                                            </div>
                                            <?php if ($item['tp_portfolio_link_switcher'] == 'yes'): ?>
                                            </a>
                                        <?php endif; ?>
        ...
        <?php elseif ($settings['tp_design_style'] == 'layout-3'): ?>
            ...
            <div class="porfolio-inner__thumb-wrapper tp-portfolio-effect portfolio-list-scroll-text-animation p-relative fix  black-bg-3 pt-80 pb-50 tp-el-section"
                data-scrub="0.0001">

                <?php if (!empty($settings['tp_portfolio_bg_text'])): ?>
                    <div class="portfolio-list-scroll-text pb-80 d-flex align-items-center tp-el-bg-text">
                    ...
                    <div class="row grid gx-90">
                        <?php foreach ($settings['tp_portfolio_list'] as $key => $item):
                            ...
                            <div class="col-lg-6 grid-item">
                                <div class="tp-portfolio-item-wrapper tp-el-box">
                                    <div class="tp-portfolio-item mb-70">
                                        <?php if ($item['tp_portfolio_link_switcher'] == 'yes'): ?>
                                            ...
                                            <div
                                                class="tp-portfolio-thumb <?php echo ($item['tp_portfolio_image_height_switch'] == 'yes') ? 'img-4' : 'img-1'; ?> w-img fix ">

                                                <div class="tp-portfolio-thumb-img">
                                                    <img data-speed="0.85" src="<?php echo esc_url($tp_portfolio_image_url); ?>"
                                                        alt="<?php echo esc_url($tp_portfolio_image_alt); ?>">
                                                </div>
                                            </div>
                                            <div class="tp-portfolio-content">

                                                <h3 class="tp-portfolio-title tp-el-box-title">
                                                ...
                                                <div class="tp-portfolio-meta d-flex align-items-center">
                                                    ...
                                                    <span
                                                        class="tp-portfolio-meta-count tp-el-box-number"><?php echo tp_kses($count); ?></span>
                                                    ...
                                                    <span class="tp-portfolio-meta-arrow tp-el-box-link">
                                                        <svg width="42" height="13" viewBox="0 0 42 13" fill="none"
                                                            ...
                                                            <path d="M0.999998 6.33179H41" stroke="currentColor" stroke-width="1.5"
                                                    ...
                                                    <div class="tp-portfolio-meta-hover">
                                                        <?php if (!empty($item['tp_portfolio_cat'])): ?>
                                                            <span
                                                                class="tp-el-box-cat"><?php echo tp_kses($item['tp_portfolio_cat']); ?></span>
                                                        <?php endif; ?>
                                                        <span
                                                            class="tp-portfolio-meta-link tp-el-box-link"><?php echo tp_kses($item['portfolio_link_text']); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php if ($item['tp_portfolio_link_switcher'] == 'yes'): ?>
        ...
        <?php else:
            ...
            <section class="tp-portfolio-area tp-btn-trigger-2 p-relative z-index-1 pt-280 pb-40 fix tp-el-section">
                            ...
                            <div class="tp-portfolio-wrapper pr-30 pt-55">
                                <?php if (!empty($settings['tp_portfolio_section_title_show'])): ?>
                                    <div class="tp-section-title-wrapper mb-60">
                                        <div
                                            class="tp-section-title-inner <?php echo esc_attr($this->tp_common_animation_get($settings, 'desc_animation')) ?> p-relative tp-el-content">

                                            <?php if (!empty($settings['tp_portfolio_sub_title'])): ?>
                                                <span
                                                    class="tp-section-subtitle tp-portfolio-subtitle tp-el-subtitle"><?php echo tp_kses($settings['tp_portfolio_sub_title']); ?></span>
                                            <?php endif; ?>
                                ...
                                <div class="tp-portfolio-item-wrapper">
                                    <?php foreach ($settings['tp_portfolio_list'] as $key => $item):
                                        ...
                                        <?php if ($key == 0): ?>
                                            <!-- portfolio item -->
                                            <div class="tp-portfolio-item mb-70 tp-el-box">
                                                <?php if ($item['tp_portfolio_link_switcher'] == 'yes'): ?>
                                                    <a <?php echo tp_implode_html_attributes($attrs); ?>>
                                                    <?php endif; ?>
                                                    ...
                                                    <div class="tp-portfolio-content">
                                                        ...
                                                        <div class="tp-portfolio-meta d-flex align-items-center">
                                                            <span
                                                                class="tp-portfolio-meta-count tp-el-box-number"><?php echo esc_html__('01', 'tpcore'); ?></span>
                                                ...
                                                <span class="tp-btn-circle-arrow-2">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                        ...
                                                        <path d="M15 1L1 15" stroke="currentColor" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M3.78415 1.02414L14.9987 1L14.9756 12.2155" stroke="currentColor"
                                                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                </span>
                                            </span>
