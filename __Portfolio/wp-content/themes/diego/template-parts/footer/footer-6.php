...
$diego_footer_bg_color_from_page = function_exists( 'tpmeta_field' ) ? tpmeta_field( 'diego_footer_bg_color' ) : '';
$footer_bg_color = get_theme_mod( 'diego_footer_bg_color', '#F5F5F5' );
                ...
                <div class="container">
                    <div class="tp-footer-bottom-wrapper">
                        <div class="row align-items-center">
                            ...
                            <div class="<?php echo esc_attr($diego_copyright_center); ?>">
                                <div class="tp-footer-copyright">
                                    <p><?php print diego_copyright_text(); ?></p>
                                </div>
                            </div>

                            <?php if ( !empty( $diego_footer_payment ) ): ?>
                            <div class="col-md-6">
                                <div class="tp-footer-payment text-md-end">
                                    <p>
                                        <img src="<?php echo esc_url($diego_footer_payment) ?>" alt="<?php echo esc_attr__('payment', 'diego')?>">
                                    </p>
                                </div>
                            </div>
                            <?php endif; ?>
