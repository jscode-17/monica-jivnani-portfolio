...
$diego_theme_btn_switch = get_theme_mod('diego_theme_btn_switch', true);
      ...
      <div class="container-fluid">
         <div class="row align-items-center">
            ...
            <div class="<?php echo esc_attr($diego_menu_col); ?>">
               <div class="tp-header-4__menu header-menu-main <?php echo esc_attr($diego_menu_align); ?>">
                  ...
                  <div class="tp-header-3__right-action d-flex align-items-center justify-content-end">
                     ...
                     <?php if (!empty($diego_tel_text)): ?>
                        <div class="tp-header-3__btn d-none d-md-block">
                           <a class="tp-btn-white" href="<?php echo esc_url($diego_tel_link); ?>" target="_blank"
                              rel="nofollow">
   ...
   <div
      ...
      <div class="container-fluid">
         <div class="row align-items-center">
            ...
            <div class="<?php echo esc_attr($diego_menu_col); ?>">
               <div class="tp-header-4__menu header-menu-sticky <?php echo esc_attr($diego_menu_align); ?>">
                  <nav class="tp-main-menu-content">
                     <?php diego_header_menu(); ?>
                  </nav>
